        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                if (password_verify($password, $user->senha)) {
                    $session_data = ['nome' => $user->nome, 'email' => $user->email, 'url_image_user' => $user->url_image_user, 'id' => $user->idUsuarios, 'permissao' => $user->permissoes_id, 'sistema' => $user->sistema, 'logado' => true];
