            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?= current_url() ?>" id="formNotaFiscal" enctype="multipart/form-data" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="userfile" type="file" name="userfile" /> (Arquivos suportados .txt .pdf .gif .png .jpg .jpeg)
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="notaFiscal" type="number" name="notaFiscal" />
                        </div>
                    </div>
                    <div class="control-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#fornecedor").autocomplete({
            source: "<?php echo base_url(); ?>index.php/NotasFiscais/autoCompleteFornecedor",
            minLength: 1,
            close: function(ui) {
