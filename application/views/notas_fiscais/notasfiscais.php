                        ...
                        foreach ($results as $r) :  ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else : ?>
                                        <?php if ($r->tipo == '.pdf') : ?>
                                        <a href="<?= $r->url ?>"> <img style="width:50%; margin-left:25%;" src="<?= base_url().'/assets/icons/pdf.png' ?> "></a>
                                        <?php else : ?>
                                            <a href="<?= $r->url ?>"> <img style="width:50%; margin-left:25%;" src="<?= base_url().'/assets/icons/file.png' ?> "></a>  
                                        <?php endif ?>
                                    <?php endif ?>
                                </td>
                                <td><?= $r->nomeCliente ?></td>
